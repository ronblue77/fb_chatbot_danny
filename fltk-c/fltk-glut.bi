#ifndef __FLTK_GLUT_BI__
#define __FLTK_GLUT_BI__
...
' #######################################
Fl_Extends(Fl_Glut_Window,Fl_GL_Window)
 Fl_Extends(Fl_Glut_WindowEx,Fl_Glut_Window)
...
' same as gluLookAt
sub LookAt(byval ex as double, byval ey as double, byval ez as double, _
...
function IMD(byval m as const double ptr, byval o as double ptr) as integer
  dim as double t(15)=any
...
sub MMD(byval a as const double ptr, byval b as const double ptr, byval r as double ptr)
...
' o = m4x4 * v4
sub MMV(byval m as const double ptr, byval v as const double ptr, byval o as double ptr)
...
function UnProject(byval winx as double, byval winy as double , byval winz as double, _
                   byval mMatrix  as const double ptr, _
                   byval pMatrix  as const double ptr, _
                   byval viewport as const long ptr, _
                   byval ox as double ptr, byval oy as double ptr, byval oz as double ptr) as long
  dim as double t(15)
...
sub MouseUnproject(byval mx as single, byval my as single, byval mz as single, _
